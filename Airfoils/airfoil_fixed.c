...
double main()
{
    ...
    sprintf(output_file, "result//%s_fixed-%d.dat", airfoil_name, code);
    ...
    {
        coordinate[i][1] = code * coordinate[i][1];
        coordinate[i][2] = code * coordinate[i][2];
        coordinate[i][3] = code * coordinate[i][3];
    }
